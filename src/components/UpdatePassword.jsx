...
class UpdatePassword extends React.Component {
    ...
    checkPasswordRequest(email, password, currentpassword, callback) {
        ...
        xhrpass.addEventListener('load', () => {
            if (xhrpass.status !== 200) {
                ...
                const errors = xhrpass.response.errors
                    ? xhrpass.response.errors
                    : {};
    ...
    render() {
        ...
        return (<UpdatePasswordForm onSubmit={this.processForm} onChange={this.changeUser} errors={this.state.errors} user={this.state.user} snackbarOpen={this.state.snackbarOpen} handleSnackbarClose={this.handleSnackbarClose}/>);
