  ...
  render() {
    ...
    return  (
        <div style={ideaCard}>
                    <Card>
                      <CardHeader
                        title={this.props.idea.user}
                        subtitle={this.props.idea.userEmail}
                        avatar="https://image.shutterstock.com/z/stock-vector-reach-idea-with-human-hand-145799489.jpg"
                      />
                      <CardMedia overlay={<CardTitle title={this.props.idea.title} subtitle="" />}>
                        <img src={this.props.idea.image} />
                      </CardMedia>
                      <CardText>
                        {this.props.idea.description}
                      </CardText>
                      <ActionBar id={this.props.idea._id} itemType="innovations" style={{marginBottom:'100px'}}/>
                    </Card>
                </div>
    );
