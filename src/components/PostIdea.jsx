...
class PostIdea extends React.Component {
    ...
    render() {
        return (
            <div>
                <br></br>
                <TextField hintText="Title of innovation idea ..." multiLine={true} fullWidth={true} style={style} value={this.state.textFieldTitle} onChange={this.handleTitleFieldChange}/>
                <TextField hintText="Description ..." multiLine={true} fullWidth={true} style={style} disabled={false} value={this.state.textFieldDescription} onChange={this.handleDescriptionFieldChange}/>
                <TextField hintText="Picture URL ..." multiLine={true} fullWidth={true} style={style} disabled={false} value={this.state.textFieldPictureURL} onChange={this.handlePictureURLFieldChange}/>
                <br/><br/>
                ...
                <div style={ideaCardList}>
                    ...
                    <div style={ideaCard}>
                        <Card>
                            <CardHeader title={this.state.userText} subtitle={this.state.userEmailText} avatar="https://image.shutterstock.com/z/stock-vector-reach-idea-with-human-hand-145799489.jpg"/>
                            ...
                            <CardActions>
                                <div style={{
                                    ...
                                    <div style={ideaCardActionBar}>
                                        <img style={{
                                            paddingRight: '10px'
                                        }} src="../assets/comment-icon.png"/>3 Comments</div>
                                    <div >
                                        <img style={{
                                            paddingRight: '10px'
                                        }} src="../assets/thumb-up-icon.png"/>4 Likes</div>
                                </div>
                            </CardActions>
