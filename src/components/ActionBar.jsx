    ...
    return  (
                <div>
                    <div style={{ display:'flex', alignItems:'center', width:'66%'}}>
                      ...
                      <img style={{paddingRight:'10px'}}  src="../assets/comment-icon.png"/>{this.state.comments.length} Comments</div>
                      <div onClick={this.submitLike} style={ideaCardActionBar}>
                      <img style={{paddingRight:'10px'}} src="../assets/thumb-up-icon.png"/>{this.state.likes.length} Likes</div>
                      <div style={ideaCardActionBar} onClick={this.reportItem}>
                      <img style={{paddingRight:'10px'}} src="../assets/report-problem-icon.png"/>Report</div>
                    </div>
                    ...
                    {this.state.comments.map(function(item) {
                        return  <Comment comment={item} style={{alignItems:'center'}}/>
                    })}
                    </div>
