        ...
        xhr.addEventListener('load', () => {
            if (xhr.status === 200) {
                ...
                for (var index = 0; index < userStr.length; index++) {
                    ...
                    if (userStr.charAt(index) === 'e' && userStr.charAt(index + 1) === 'm' && userStr.charAt(index + 2) === 'a' && userStr.charAt(index + 3) === 'i' && userStr.charAt(index + 4) === 'l') {
                        for (var eId = index + 8; eId < userStr.length; eId++) {
                            if (userStr[eId] === '"' && userStr[eId + 1] === ',' && userStr[eId + 2] === '"') {
                                break;
                            } else {
                    ...
                    // Extract user's name
                    if (userStr.charAt(index) === '"' && userStr.charAt(index + 1) === ',' && userStr.charAt(index + 2) === '"' && userStr.charAt(index + 3) === 'n' && userStr.charAt(index + 4) === 'a' && userStr.charAt(index + 5) === 'm' && userStr.charAt(index + 6) === 'e') {
                        for (var nId = index + 10; nId < userStr.length; nId++) {
                            if (userStr[nId] === '"' && userStr[nId + 1] === ',' && userStr[nId + 2] === '"') {
                                break;
                            } else {
                    ...
                    if (userStr.charAt(index) === '"' && userStr.charAt(index + 1) === ',' && userStr.charAt(index + 2) === '"' && userStr.charAt(index + 3) === 'a' && userStr.charAt(index + 4) === 'd' && userStr.charAt(index + 5) === 'm' && userStr.charAt(index + 6) === 'i' && userStr.charAt(index + 7) === 'n') {
                        for (var pId = index + 11; pId < userStr.length; pId++) {
                            if (userStr[pId] === '"' && userStr[pId + 1] === ',' && userStr[pId + 2] === '"') {
                                break;
                            } else {
                    ...
                    if (userStr.charAt(index) === '"' && userStr.charAt(index + 1) === ',' && userStr.charAt(index + 2) === '"' && userStr.charAt(index + 3) === 'b' && userStr.charAt(index + 4) === 'a' && userStr.charAt(index + 5) === 'n' && userStr.charAt(index + 6) === 'n' && userStr.charAt(index + 7) === 'e' && userStr.charAt(index + 8) === 'd') {
                        for (var sId = index + 12; sId < userStr.length; sId++) {
                            if (userStr[sId] === '"' && userStr[sId + 1] === ',' && userStr[sId + 2] === '"') {
                                break;
                            } else {
                        ...
                        if (userPrivilege !== 'true') {
                            ...
                            this.setState({tableData: rowArray});
                        }
